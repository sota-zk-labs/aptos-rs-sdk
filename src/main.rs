...
use aptos_rs_sdk::queries::get_events::get_events::OrderBy::{Desc};
...
async fn main() {
    ...
    let events = aptos_client.get_account_events_by_event_type(
        AccountAddress::from_hex_literal("0x3f63f9a175fe45adcb3bbfae689f4e814e4fd955c3db7bea89735b1b5d904a5b").unwrap(),
        MoveType::from_str(&format!("{}::fri_statement::FriCtx", "0xd86ef4ed97b15752707c861650d084d2ad181357b7f968a2e08a931c63187c7")).unwrap(),
